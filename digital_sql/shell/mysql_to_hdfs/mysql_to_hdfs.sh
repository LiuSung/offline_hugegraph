...
APP=gmall
sqoop=/root/software/sqoop/bin/sqoop
...
import_data(){
$sqoop import \
--connect jdbc:mysql://xuanbishe01:3306/$APP \
--username root \
--password 000000 \
...
hadoop jar /root/software/hadoop/share/hadoop/common/hadoop-lzo-0.4.21-SNAPSHOT.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
